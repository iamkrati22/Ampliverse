      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-justify text-white/60 mb-6 max-w-md">
              We are a global communications advisory, fueling purposeful
              visibility for tomorrow’s innovators. We are bridging the gap
              between purpose and performance through collaborative solutions
              that transform intent into impact and reach into results.
            </p>
        ...
        <div className="pt-8 border-t border-[#1a1a2e] text-center md:flex md:justify-between md:text-left">
          <p className="text-white/40 mb-4 md:mb-0">
            &copy; {currentYear} Ampliverse. All rights reserved.
          </p>
