        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a
                target="_blank"
                href="https://www.instagram.com/ampliverse.in?igsh=MXZqc21wOHNxcWg0YQ=="
                className="w-10 h-10 rounded-full bg-neutral-200 dark:bg-[#1a1a2e] flex items-center justify-center hover:bg-neutral-300 dark:hover:bg-[#2a2a40] transition-colors"
              ...
              <a
                target="_blank"
                href="https://www.facebook.com/share/196ThiHEXD/?mibextid=wwXIfr"
                className="w-10 h-10 rounded-full bg-neutral-200 dark:bg-[#1a1a2e] flex items-center justify-center hover:bg-neutral-300 dark:hover:bg-[#2a2a40] transition-colors"
                aria-label="Facebook"
              >
                <svg
