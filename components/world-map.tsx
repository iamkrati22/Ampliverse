...
export function WorldMap() {
  ...
  return (
    <div ref={ref} className="h-full w-full max-w-full overflow-x-hidden">
      <div className="relative w-full max-w-full h-[700px] bg-[#f8f7f4] dark:bg-[#0a0a14] rounded-lg overflow-hidden border border-gray-200 dark:border-[#1a1a2e]">
