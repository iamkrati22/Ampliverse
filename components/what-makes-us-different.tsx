    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center mb-16">
          <span className="text-sm font-medium tracking-wider text-white/60 uppercase flex items-center justify-center mb-2">
                  ...
                  >
                    <span
                      className={`w-7 h-7 rounded-full border-2 flex items-center justify-center mb-1 transition-all duration-300 ${
                        activeFeature === idx
                          ? "border-orange-500 bg-[#0a0a14]"
                          : "border-white/25 bg-[#0a0a14]"
                      }`}
                    >
                      {activeFeature === idx && (
                  ...
                  <div className="flex-1 pb-6">
                    <div
                      className={`text-lg md:text-xl font-bold transition-colors duration-300 ${
                        activeFeature === idx ? "text-white" : "text-white/60"
                      }`}
                    >
                      {feature.title}
                    </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center w-full min-w-[340px] max-w-xl">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center px-8 py-12">
                ...
                <div className="mb-8 flex items-center justify-center w-16 h-16 border border-white/30 rounded-md">
                  {features[activeFeature].icon}
                </div>
                <h3 className="text-xl md:text-2xl font-bold mb-4 leading-tight">
                  {features[activeFeature].title}
                </h3>
                <p className="text-white/80 mb-8 leading-relaxed text-base md:text-lg max-w-xl">
